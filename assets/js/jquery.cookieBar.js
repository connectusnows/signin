...
(function ($) {
  ...
  translation['en'] = {
    message: 'Our services are made possible through the use of cookies',
    acceptText: 'OK',
  ...
  var methods = {
    init: function (options) {
      ...
      var defaults = {
        infoLink: 'https://www.google.com/policies/technologies/cookie/',
        infoTarget: '_blank',
        wrapper: 'body',
        expireDays: 365,
        style: 'top',
      ...
      if (methods.getCookie('cookie-state') !== 'accepted') {
        methods.displayBar();
      }
      ...
      $(document).on('click', cookieBar + ' .cookie-bar__btn', function (e) {
        ...
        methods.setCookie('cookie-state', 'accepted', config.expireDays);
        methods.hideBar();
      });
    ...
    displayBar: function () {
      ...
      var infoLink = '<a href="' + config.infoLink + '" target="' + config.infoTarget + '" class="cookie-bar__link cookie-bar__link--cookie-info">' + translation[config.language].infoText + '</a>';
